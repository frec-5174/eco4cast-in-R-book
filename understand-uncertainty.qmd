...
This chapter sets the foundation for @sec-second-forecast. In prep for @sec-second-forecast, there is code-based version of this chapter that provides example code and introduces key that will guide your work adding uncertainty to your forecast from @sec-first-forecast.
