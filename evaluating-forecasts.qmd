...
You may need to replace the example code in the STAC catalog with the following to avoid errors:
```
...
2.  Access the observations that are associated with your selected target variable (see <https://www.neon4cast.org>). 
