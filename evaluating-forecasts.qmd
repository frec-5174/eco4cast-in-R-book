...
```{r}
#| echo: false
forecast1 <- rnorm(100, mean = observed, sd = 2)
forecast2 <- rnorm(100, mean = 6, sd = 2)
forecast3<- rnorm(100, mean = observed, sd = 5)
dy <- 0.0001
...
df <- tibble(y1 = c(values_evaluated,values_evaluated,values_evaluated),
             ...
             variable = c(rep(paste0("mean = 8, sd = 2, CRPS: ",scoringRules::crps_sample(observed, forecast1)), length(values_evaluated)),
                          rep(paste0("mean = 6, sd = 2 CRPS: ",scoringRules::crps_sample(observed, forecast2)), length(values_evaluated)), 
                          rep(paste0("mean = 8, sd = 5 CRPS: ",scoringRules::crps_sample(observed, forecast3)), length(values_evaluated))))
