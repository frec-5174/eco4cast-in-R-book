# Using Ecological Forecasts to Guide Decision Making {#sec-eddiemod8}
...
Complete activities A, B, and C in the [R Shiny application](https://macrosystemseddie.shinyapps.io/module8/). The answers to the questions will be provided within the Shiny App.\
