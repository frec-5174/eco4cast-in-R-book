...
- Go to the Tools -> Global Options.. -> General and uncheck "Restore .Rdata into workspace at startup and set Save workspace to .Rdata on exit" to "Never".  
- In the Global Options window go to "Code" and check "Use native pipe operator, |> (Requires R 4.1+)"
- Click "Accept" and "Ok"
