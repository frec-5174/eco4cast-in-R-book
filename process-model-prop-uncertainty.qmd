...
The problem set is located in `process-model-uncert.qmd` in https://github.com/frec-5174/book-problem-sets. You can fork the repository or copy the [code](https://github.com/frec-5174/book-problem-sets/blob/main/process-model-uncert.qmd) into your own quarto document
