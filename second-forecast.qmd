...
2. Modify your "forecast_code_template.R" to include the additional sources of uncertainty
3. Run the "forecast_code_template.R" to generate a forecast, submit the forecast, and generate the plot of the forecast.
4. Update your model description at the top of "forecast_code_template.R" to describe the new sources of uncertainty.
6. Commit the updated "forecast_code_template.R" to GitHub.
